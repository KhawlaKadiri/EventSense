...
public class TicketRestController {
    ...
    public ResponseEntity<List<Ticket>> getByUser(
            @PathVariable int userId
    ) {

        return ResponseEntity.ok(
                ticketService.findByUser(userId)
        );
    }
    ...
    public ResponseEntity<List<Ticket>> getByEvent(
            @PathVariable int eventId
    ) {

        return ResponseEntity.ok(
                ticketService.findByEvent(eventId)
        );
    }
    ...
    public ResponseEntity<Boolean> seatExists(
